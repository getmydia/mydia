...
class TypeScriptDocumentsVisitor extends visitor_plugin_common_1.BaseDocumentsVisitor {
    ...
    constructor(schema, config, documentNode, outputPath) {
        super(config, {
            ...
            maybeValue: (0, visitor_plugin_common_1.getConfigValue)(config.maybeValue, 'T | null'),
            inputMaybeValue: (0, visitor_plugin_common_1.getConfigValue)(config.inputMaybeValue, 'T | null | undefined'),
        }, schema);
        this.config.enumValues = (0, visitor_plugin_common_1.parseEnumValues)({
            schema,
        ...
        const documentWithAllFragments = {
            ...documentNode,
            definitions: [
                ...documentNode.definitions.filter(d => d.kind !== graphql_1.Kind.FRAGMENT_DEFINITION),
        ...
        const processorConfig = {
            ...
            wrapTypeWithModifiers: (baseType, type) => {
                return (0, visitor_plugin_common_1.wrapTypeWithModifiers)(baseType, type, {
                    wrapOptional: type => (0, visitor_plugin_common_1.printTypeScriptMaybeType)({
                        type,
        ...
        this.setVariablesTransformer(new ts_operation_variables_to_object_js_1.TypeScriptOperationVariablesToObject({
        ...
        for (const typeNode of typeNodes.reverse()) {
            if (typeNode.type === 'NamedType') {
                ...
                if (!typeNode.isNonNullable) {
                    typePart = (0, visitor_plugin_common_1.printTypeScriptMaybeType)({
                        type: typePart,
        ...
        return Object.entries(imports).reduce((res, [importSource, importParams]) => {
            ...
            for (const [identifier, identifierMetadata] of Object.entries(importParams.identifiers)) {
                if (identifierMetadata.asDefault) {
                    res.push((0, visitor_plugin_common_1.buildTypeImport)({
                        identifier,
                        source: importSource,
                        asDefault: true,
                        useTypeImports: this.config.useTypeImports,
        ...
        (0, graphql_1.visitWithTypeInfo)(typeInfo, {
            Field: () => {
                ...
                if (fieldType) {
                    ...
                    if (namedType instanceof graphql_1.GraphQLScalarType) {
