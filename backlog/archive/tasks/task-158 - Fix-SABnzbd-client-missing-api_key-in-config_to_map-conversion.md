...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 config_to_map includes api_key field in lib/mydia/downloads.ex
- [ ] #2 config_to_map includes api_key field in lib/mydia/downloads/untracked_matcher.ex
- [ ] #3 SABnzbd client can successfully fetch queue items without KeyError
