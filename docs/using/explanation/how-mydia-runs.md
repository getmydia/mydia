...
[pre-migration backup](../how-to/backup-restore.md): copying one file is a thing
Mydia can do for you, and dumping a database server is not. The database adapter is compiled
