defmodule Mydia.RemoteAccessHelpers do
  @moduledoc """
  Seeds the `Mydia.Player.remote_access_enabled?/0` cache directly.
  ...
  @enabled_key {Mydia.Player.RemoteAccess, :enabled}

  @doc "Forces `Mydia.Player.remote_access_enabled?/0` to return the given value."
  ...
  @doc "Clears the cached flag so the next read recomputes it."
