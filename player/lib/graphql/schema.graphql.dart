...
enum Enum$SearchResultType {
  ...
  factory Enum$SearchResultType.fromJson(String value) =>
      fromJson$Enum$SearchResultType(value);

  String toJson() => toJson$Enum$SearchResultType(this);
}

String toJson$Enum$SearchResultType(Enum$SearchResultType e) {
  switch (e) {
    case Enum$SearchResultType.MOVIE:
      return r'MOVIE';
    case Enum$SearchResultType.TV_SHOW:
      return r'TV_SHOW';
    case Enum$SearchResultType.EPISODE:
      return r'EPISODE';
    case Enum$SearchResultType.COLLECTION:
      return r'COLLECTION';
    case Enum$SearchResultType.$unknown:
      return r'$unknown';
  }
}

Enum$SearchResultType fromJson$Enum$SearchResultType(String value) {
  switch (value) {
    case r'MOVIE':
      return Enum$SearchResultType.MOVIE;
    case r'TV_SHOW':
      return Enum$SearchResultType.TV_SHOW;
    case r'EPISODE':
      return Enum$SearchResultType.EPISODE;
    case r'COLLECTION':
      return Enum$SearchResultType.COLLECTION;
    default:
      return Enum$SearchResultType.$unknown;
  }
}
