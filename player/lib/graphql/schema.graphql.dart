...
enum Enum$CuratedListType {
  ...
  factory Enum$CuratedListType.fromJson(String value) =>
      fromJson$Enum$CuratedListType(value);

  String toJson() => toJson$Enum$CuratedListType(this);
}

String toJson$Enum$CuratedListType(Enum$CuratedListType e) {
  switch (e) {
    case Enum$CuratedListType.TRENDING:
      return r'TRENDING';
    case Enum$CuratedListType.POPULAR:
      return r'POPULAR';
    case Enum$CuratedListType.UPCOMING:
      return r'UPCOMING';
    case Enum$CuratedListType.NOW_PLAYING:
      return r'NOW_PLAYING';
    case Enum$CuratedListType.ON_THE_AIR:
      return r'ON_THE_AIR';
    case Enum$CuratedListType.AIRING_TODAY:
      return r'AIRING_TODAY';
    case Enum$CuratedListType.$unknown:
      return r'$unknown';
  }
}

Enum$CuratedListType fromJson$Enum$CuratedListType(String value) {
  switch (value) {
    case r'TRENDING':
      return Enum$CuratedListType.TRENDING;
    case r'POPULAR':
      return Enum$CuratedListType.POPULAR;
    case r'UPCOMING':
      return Enum$CuratedListType.UPCOMING;
    case r'NOW_PLAYING':
      return Enum$CuratedListType.NOW_PLAYING;
    case r'ON_THE_AIR':
      return Enum$CuratedListType.ON_THE_AIR;
    case r'AIRING_TODAY':
      return Enum$CuratedListType.AIRING_TODAY;
    default:
      return Enum$CuratedListType.$unknown;
  }
}
