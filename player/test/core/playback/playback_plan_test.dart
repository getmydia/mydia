...
void main() {
  group('QualityChoice', () {
    ...
    test('fromRung maps Auto to auto', () {
      expect(QualityChoice.fromRung(QualityRung.auto), QualityChoice.auto);
    });

    test('toString names the kind, or the rung for a fixed choice', () {
      expect(QualityChoice.auto.toString(), 'QualityChoice(auto)');
