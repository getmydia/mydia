defmodule Mydia.Subtitles do
  ...
  alias Mydia.Repo
  alias Mydia.Subtitles.{Subtitle, MediaHash, Downloader, ProviderChain}
  ...
  - `opts` - Keyword list of options:
    ...
    - `:user_id` - Binary ID of the user whose configured providers to search
      (default: `nil`, which searches the zero-config relay default)
  ...
  # Perform subtitle search across the user's configured provider chain.
  defp perform_search(params, user_id) do
    case ProviderChain.search(user_id, params) do
