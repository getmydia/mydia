defmodule Mydia.Subtitles.Candidate do
  ...
  # `provider_type` rides along with `provider_id` so the download side can
  # resolve an adapter even when the config row it came from was edited or
  # removed inside the 15 minute window. The id alone would leave a valid,
  # unexpired token pointing at nothing.
  @fields [
    :provider_id,
    :provider_type,
    :provider_name,
