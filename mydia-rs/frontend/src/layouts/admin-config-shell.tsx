...
const CONFIG_TABS: ConfigTab[] = [
  { to: "/admin/config/system", icon: "chart-bar", label: "Status" },
  { to: "/admin/config/settings", icon: "cog", label: "Settings" },
  { to: "/admin/config/quality-profiles", icon: "sparkles", label: "Quality" },
  { to: "/admin/config/download-clients", icon: "arrow-down", label: "Clients" },
  { to: "/admin/config/indexers", icon: "magnifying-glass", label: "Indexers" },
  { to: "/admin/config/library-paths", icon: "folder", label: "Library" },
  { to: "/admin/config/media-servers", icon: "desktop", label: "Media Servers" },
  { to: "/admin/config/remote-access", icon: "signal", label: "Remote Access" },
];
...
function TabIcon({ name }: { name: string }) {
  const icons: Record<string, string> = {
    ...
    cog: "M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m-8.457 3.077l1.41-.513m14.095-5.13l1.41-.513M5.106 17.785l1.15-.964m11.49-9.642l1.149-.964M7.501 19.795l.75-1.3m8.5-12.99l.75-1.3m-6.063 16.658l.26-1.477m2.605-14.772l.26-1.477m0 17.726l-.26-1.477M10.698 4.614l-.26-1.477M16.5 19.794l-.75-1.299M7.5 4.205L12 12m6.894 5.785l-1.149-.964M6.256 7.178l-1.15-.964m15.352 8.864l-1.41-.513M4.954 9.435l-1.41-.514M12.002 12l-3.75 6.495",
