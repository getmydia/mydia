...
pub struct Model {
    ...
    pub import_next_retry_at: Option<DateTimeSecs>,
    pub import_failed_at: Option<DateTimeSecs>,
    pub library_path_id: Option<UuidText>,
    pub imported_at: Option<DateTimeSecs>,
    pub match_status: Option<String>,
    pub last_progress_at: Option<DateTimeMicros>,
